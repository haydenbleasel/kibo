    ...
    <Tabs className="w-full max-w-md" defaultValue="overview">
      ...
      <TabsContent value="overview">
        <div className="rounded-lg border bg-card p-6 text-card-foreground shadow-sm">
          ...
          <p className="text-muted-foreground text-sm">
            View a comprehensive summary of your account activity, recent
            updates, and key metrics at a glance.
          </p>
        </div>
      </TabsContent>
      <TabsContent value="analytics">
        <div className="rounded-lg border bg-card p-6 text-card-foreground shadow-sm">
          ...
          <p className="text-muted-foreground text-sm">
            Dive deep into your data with detailed analytics, trends, and
